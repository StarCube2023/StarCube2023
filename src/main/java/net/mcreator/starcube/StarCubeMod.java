...
@Mod("star_cube")
public class StarCubeMod {
	public static final Logger LOGGER = LogManager.getLogger(StarCubeMod.class);
	public static final String MODID = "star_cube";
